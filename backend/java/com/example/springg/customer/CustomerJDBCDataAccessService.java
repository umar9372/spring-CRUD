...
public class CustomerJDBCDataAccessService implements CustomerDao {
    ...
    /*jdbcTemplate.queryForObject: This method is used to execute the SQL query and retrieve a single result.
sql: The SQL query to execute.
Integer.class: Specifies that the result should be mapped to an Integer object.
email: The parameter to replace the ? placeholder in the SQL query.
The result of the query is stored in the count variable.*/
    @Override
